                                ...
                                <ul className="mb-3 d-flex p-0" style={{ listStyle: "none" }}>
                                    ...
                                    <li style={{ marginLeft: 10, fontSize: 13 }}>
                                        <a href="" className="text-decoration-none">
                                            <strong className="me-2">{product.rating}</strong>({product.rating_count})
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <div className="d-flex">
                                                    {size.map((s, index) => (
                                                        <div>
                                                            ...
                                                            <button key={index} className='btn btn-secondary m-1 size_button' onClick={handleSizeButtonClick}>{s.name}</button>
                                                        </div>
                                                    ))}
                                                </div>   
                                            </div>
